...
$error='';
  if(isset($_GET['company'])) {
      ...
      $pageArray=explode('<div class="sub show-more-box about" style="flex-basis: 100px">',$forecastpage);
...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    placeholder="eg RELIANCE, TATASTEEL, HDFCBANK...." value="<?php if(isset($_GET['company']))echo $_GET['company']; ?>">
  </div>
